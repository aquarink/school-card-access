<html>
<head>
<title>Parent Check</title>
</head>

<body>

    <h1>Check Parent Card</h1>

    <form action="" method="POST">
        <table>
            <tr>
                <td>Tap Parent Card</td>
                <td><input autofocus name="hexaCard" type="password" placeholder="Tap Parent Card Here" required></td>
